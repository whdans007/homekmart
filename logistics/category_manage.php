<?php
$page_title = 'Category Management - Logistics Center';
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($action === 'add') {
        ...
        if ($name_en !== '') {
            ...
            lc_set_flash('success', "Category '{$name_en}' registered successfully");
        }
    } elseif ($action === 'edit') {
        ...
        if ($cid > 0 && $name_en !== '') {
            ...
            lc_set_flash('success', "Category '{$name_en}' updated successfully");
        }
