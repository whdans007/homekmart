            ...
            <table class="w-full text-sm">
                ...
                <tr class="hover:bg-amber-100/50">
                    <td class="px-4 py-3 font-medium text-gray-900">
                        ...
                        <div class="text-xs font-semibold mt-1" style="color:#dc2626;"><?php echo htmlspecialchars(t('logistics.order_new.promo_detail', ['lot' => $promo['lot_number'] ?: '-', 'expiry' => $promo['expiry_date'] ?: '-', 'quantity' => $promo['quantity_remain'], 'unit' => $promo['unit'], 'rate' => $promo['discount_rate']])); ?></div>
                    </td>
