 ...
 * 허용 확장자 ↔ MIME 매핑
 */
function lc_product_img_allowed(): array {
    return [
        'image/jpeg' => 'jpg',
        'image/png'  => 'png',
        'image/webp' => 'webp',
 ...
 */
function lc_handle_product_image_upload(array $file, string &$error = ''): ?string {
 ...
 */
function lc_delete_product_image(?string $rel_path): void {
    if (!$rel_path) return;
