...
// 사용법: lc_print_head($title, $extraCss); ... doc-header + table(#srcTable) ...; lc_print_tail();

function lc_print_head(string $title, string $extraCss = ''): void {
?><!DOCTYPE html>
<html lang="ko">
<head>
<meta charset="UTF-8">
...
function lc_print_doc_header(string $title, array $metaItems): void {
?>
