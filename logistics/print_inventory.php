...
$filter_labels = ['all' => 'All', 'expiring' => 'Expiring D-90', 'low' => 'Low Stock'];
...
<table id="srcTable">
  ...
  <tbody>
    ...
    <?php foreach ($list as $row):
        $isLow = $row['min_stock'] > 0 && $row['total_stock'] <= $row['min_stock'];
        $days  = $row['days_left'];
        $expBadge = '';
    ...
    <tr>
      ...
      <td class="center"><?php echo $isLow ? 'Low Stock' : 'Normal'; ?></td>
    </tr>
    <?php endforeach; ?>
  </tbody>
</table>
