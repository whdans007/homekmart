...
$sql = file_get_contents(__DIR__ . '/sql/create_sales.sql');
if ($conn->multi_query($sql)) {
    ...
    echo '<strong>✅ Migration Complete</strong><br>sales_daily and sales_transfers tables created.<br>';
    echo '<small>Please delete this file: <code>run_migration.php</code></small>';
    echo '</div>';
} else {
