...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($errors)) {
        ...
        $stmt->bind_param('issdsi', $store_id, $supplier_name, $delivery_content, $amount, $payment_date, $created_by);
        $stmt->execute();
        $stmt->close();
        $conn->close();
...
<div class="max-w-xl mx-auto">
  <div class="flex items-center gap-3 mb-6">
    ...
    <h2 class="text-xl font-bold text-gray-800">비품구매지출 등록</h2>
  </div>
