...
$page_title = '외상거래처 등록 - ' . t('company.name');
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($errors)) {
        try {
            ...
            $check_stmt = $pdo->prepare("SELECT COUNT(*) FROM credit_customers WHERE name = ? AND store_id = ? AND is_active = 1");
            ...
            if ($check_stmt->fetchColumn() > 0) {
                ...
                if ($stmt->execute([$current_store_id, $name, $phone, $address, $memo])) {
                    $_SESSION['flash'] = [
                        'type' => 'success',
                        'message' => '외상거래처가 성공적으로 등록되었습니다.'
                    ];
                    header('Location: credit_customer_management.php');
                    exit;
                } else {
                    $errors[] = '외상거래처 등록 중 오류가 발생했습니다.';
                }
            }
    ...
    <div class="max-w-2xl mx-auto">
                ...
                <ol class="flex items-center space-x-2">
                    ...
                    <li>
                        <div class="flex items-center">
                            ...
                            <span class="text-gray-600">외상거래처 등록</span>
                        </div>
                    </li>
                </ol>
            </nav>
        ...
        <div class="bg-white shadow-sm rounded-lg border">
            <div class="px-6 py-4 border-b border-gray-200">
                ...
                <p class="mt-1 text-sm text-gray-600">새로운 외상거래처 정보를 입력해주세요.</p>
            </div>
