...
-- 파일명: add_customer_profile_fields_no_fk.sql
-- 목적: 모바일 앱 개발을 위한 고객 주소 및 위치 정보 추가
-- 작성일: 2025-10-03
-- 주의: 외래키 제약조건 없는 버전 (Foreign Key 오류 발생 시 사용)
-- ====================================================================
...
-- 마이그레이션 완료
SELECT '✅ customers 테이블 프로필 확장 완료 (Philippine address format, No FK)!' as status;
