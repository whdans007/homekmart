...
try {
    ...
    // Check tables
    $tables = ['kw_inbound', 'kw_inbound_batches', 'kw_suppliers', 'products'];
    ...
    // Check kw_inbound columns
    echo "kw_inbound sample data:\n";
    echo "---\n";
    $result = $conn->query("SELECT * FROM kw_inbound LIMIT 1");
