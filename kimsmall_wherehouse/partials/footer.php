...
(function() {
    ...
    var BEEP_KEY = 'kw_last_beeped_order_id'; // 알림음 중복 방지용(시각적 팝업 차단 아님)
    var SNOOZE_KEY       = 'kw_popup_snooze_until';  // 이 시각(ms)까지는 재표시 안 함
    var SNOOZE_MAXID_KEY = 'kw_popup_snooze_maxid';  // 스누즈 당시 본 최대 주문 id
