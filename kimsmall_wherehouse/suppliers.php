<?php
$page_title = "Supplier Management - KIM'S MALL WAREHOUSE";
...
try {
    ...
    $suppliers = $conn->query(
        "SELECT id, name, contact_person, phone, email, memo, created_at FROM kw_suppliers ORDER BY name ASC"
...
async function deleteSupplier(id, name) {
    ...
    formData.append('csrf_token', '<?php echo addslashes(kw_csrf_token()); ?>');
