...
$page_title = "Pending Outbound List - KIM'S MALL WAREHOUSE";
...
try {
    ...
    $cnt_sql = "SELECT COUNT(*) FROM kw_orders o $where";
    ...
    $sql = "SELECT o.id, o.order_date, o.created_at, o.total_amount, o.notes,
            ...
            LEFT JOIN kw_order_items oi ON oi.order_id = o.id
            $where
            GROUP BY o.id
            ORDER BY o.id DESC
...
(function() {
    ...
    var CSRF_TOKEN = '<?php echo htmlspecialchars(kw_csrf_token()); ?>';
