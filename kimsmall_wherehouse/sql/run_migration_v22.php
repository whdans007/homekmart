...
try {
    ...
    // 대상 컬럼 정의
    $targets = [
        ['table' => 'kw_inbound',     'column' => 'inbound_unit'],
        ['table' => 'kw_inventory',   'column' => 'unit'],
        ['table' => 'kw_order_items', 'column' => 'order_unit'],
    ];
    ...
    $alters = [
        "ALTER TABLE kw_inbound     MODIFY inbound_unit ENUM('BOX','PACK','PCS') NOT NULL DEFAULT 'PCS' COMMENT '입고 단위'",
        "ALTER TABLE kw_inventory   MODIFY unit         ENUM('BOX','PACK','PCS') NOT NULL DEFAULT 'PCS' COMMENT 'lot 단위'",
        "ALTER TABLE kw_order_items MODIFY order_unit   ENUM('BOX','PACK','PCS') NOT NULL DEFAULT 'PCS' COMMENT '주문/출고 단위'",
    ];
