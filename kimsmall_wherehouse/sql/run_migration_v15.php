<?php
/**
 * Migration v15 — kw_products capacity 컬럼 추가
 * 접속: http://main.homekmart.net/kimsmall_wherehouse/sql/run_migration_v15.php
 * 실행 후 이 파일을 삭제하세요.
 */
...
$steps = [
    'capacity 컬럼 추가' => "ALTER TABLE kw_products ADD COLUMN capacity VARCHAR(50) DEFAULT NULL COMMENT '용량/규격 (예: 500ml, 1kg, 20ea)' AFTER name_ko",
];
...
<?php endforeach; ?>
<p style="margin-top:1rem"><a href="http://main.homekmart.net/kimsmall_wherehouse/products.php">상품 목록으로 →</a></p>
