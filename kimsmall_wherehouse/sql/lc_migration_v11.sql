-- ============================================================
-- Migration v11: kw_inbound에 입력원가·할인율 컬럼 추가
-- 실행: mysql -u root -p sunset < kw_migration_v11.sql
-- ============================================================
...
UPDATE kw_inbound SET regular_price = cost_price WHERE regular_price = 0;

SELECT 'Migration v11 완료: kw_inbound regular_price, discount_rate 추가' AS result;
