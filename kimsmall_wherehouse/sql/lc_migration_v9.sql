-- ============================================================
-- Migration v9: 상품 등록/변경 이력 테이블
-- 실행: mysql -u root -p sunset < kw_migration_v9.sql
-- ============================================================

CREATE TABLE IF NOT EXISTS kw_product_history (
    ...
    INDEX idx_product_time (product_id, changed_at DESC),
...
SELECT 'Migration v9 완료: kw_product_history 생성' AS result;
