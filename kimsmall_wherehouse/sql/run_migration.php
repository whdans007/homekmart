<?php
/**
 * KIM'S MALL 창고 DB 마이그레이션 실행기
 * 접속: http://서버주소/sunset/kimsmall_wherehouse/sql/run_migration.php
 * 주의: 실행 후 이 파일을 삭제하세요.
 */
...
$existing = [];
$tables_sql = [
    'kw_products' => "CREATE TABLE IF NOT EXISTS kw_products (
    ...
    'kw_inbound' => "CREATE TABLE IF NOT EXISTS kw_inbound (
    id              INT AUTO_INCREMENT PRIMARY KEY,
    ...
    'kw_inventory' => "CREATE TABLE IF NOT EXISTS kw_inventory (
    id              INT AUTO_INCREMENT PRIMARY KEY,
    ...
    'kw_orders' => "CREATE TABLE IF NOT EXISTS kw_orders (
    id              INT AUTO_INCREMENT PRIMARY KEY,
    ...
    'kw_order_items' => "CREATE TABLE IF NOT EXISTS kw_order_items (
    id              INT AUTO_INCREMENT PRIMARY KEY,
...
<head>
    ...
    <title>KIM'S MALL 창고 DB 마이그레이션</title>
    <style>
...
<body>
<div class="card">
    <h1>🏭 KIM'S MALL 창고 DB 마이그레이션</h1>
    <p class="sub">kw_ 테이블 5개 생성 · DB: <strong><?php echo DB_NAME; ?></strong> · 버전: <?php echo htmlspecialchars($db_ver ?: '연결 실패'); ?></p>
</div>
...
<div class="card">
    ...
    <?php else: ?>
    <div class="success-box">✅ 마이그레이션 완료! <a href="<?php echo LC_BASE; ?>/login.php">KIM'S MALL 창고 로그인 →</a></div>
...
<div class="card">
    <div class="success-box">✅ 모든 테이블이 이미 존재합니다. <a href="<?php echo LC_BASE; ?>/login.php">KIM'S MALL 창고 로그인 →</a></div>
</div>
...
<div class="card">
    ...
    <form method="post">
        ...
        <button type="submit" onclick="return confirm('kw_ 테이블 5개를 생성하시겠습니까?')">
            마이그레이션 실행
        </button>
    </form>
</div>
