<?php
/**
 * Migration v11 — kw_inbound 입력원가·할인율 컬럼 추가
 * 접속: http://main.homekmart.net/kimsmall_wherehouse/sql/run_migration_v11.php
 * 실행 후 이 파일을 삭제하세요.
 */
...
$steps = [
    'regular_price 컬럼 추가' => "ALTER TABLE kw_inbound ADD COLUMN regular_price DECIMAL(15,2) DEFAULT 0.00 COMMENT '할인 전 입력 원가' AFTER cost_price",
    'discount_rate 컬럼 추가' => "ALTER TABLE kw_inbound ADD COLUMN discount_rate DECIMAL(5,2) DEFAULT 0.00 COMMENT '적용 할인율 (%)' AFTER regular_price",
    '기존 데이터 regular_price 초기화' => "UPDATE kw_inbound SET regular_price = cost_price WHERE regular_price = 0",
];
...
<?php endforeach; ?>
<p style="margin-top:1rem"><a href="/kimsmall_wherehouse/inbound.php">입고 목록으로 →</a></p>
