...
<head>
    ...
    <style>
        ...
        .chat-input-bar { position: fixed; left:50%; bottom:calc(58px + env(safe-area-inset-bottom, 0px)); transform:translateX(-50%); width:100%; max-width:480px; z-index:45; display:flex; gap:8px; padding:var(--space-3) var(--space-5); background:var(--bg-normal); border-top:1px solid var(--line-alternative); }
