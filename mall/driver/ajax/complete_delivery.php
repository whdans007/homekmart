<?php
/**
 * POST mall/driver/ajax/complete_delivery.php
 * Design Ref: mall-delivery-dispatch.design.md §4.1 — arrived → completed
 */
...
$result = mall_delivery_complete($driver['id'], $order_id);
if (!$result['success']) {
