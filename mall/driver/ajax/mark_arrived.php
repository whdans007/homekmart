<?php
/**
 * POST mall/driver/ajax/mark_arrived.php
 * Design Ref: mall-delivery-dispatch.design.md §4.1 — delivering → arrived
 */
...
$result = mall_delivery_mark_arrived($driver['id'], $order_id);
if (!$result['success']) {
