<?php
/**
 * POST mall/driver/ajax/start_delivery.php
 * Design Ref: mall-delivery-dispatch.design.md §4.1 — assigned → delivering
 */
...
$result = mall_delivery_start($driver['id'], $order_id);
if (!$result['success']) {
