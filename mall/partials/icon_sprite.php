<?php
/**
 * 아이콘 스프라이트 — 화면당 1회만 include.
 * 사용: <svg class="icon"><use href="#i-search"></use></svg>
 * 참고: 실제 Wanted Icon 세트 라이선스 파일이 없어 근사 대체 글리프로 구성했다.
 * README(design_handoff_home_k_mart) Assets 절 요구대로 24x24, fill="currentColor" 기준.
 */
?>
<svg xmlns="http://www.w3.org/2000/svg" style="display:none;">
  ...
  <symbol id="i-bell" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round">
    <path d="M6 10a6 6 0 0 1 12 0c0 5 2 6 2 6H4s2-1 2-6Z"></path><path d="M10 20a2 2 0 0 0 4 0"></path>
  </symbol>
  ...
  <symbol id="i-chev-left" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round">
    <polyline points="15 5 8 12 15 19"></polyline>
  </symbol>
  <symbol id="i-chev-right" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round">
    <polyline points="9 5 16 12 9 19"></polyline>
  </symbol>
  <symbol id="i-plus" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round">
  ...
  <symbol id="i-location" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round">
    <path d="M12 21s7-6.2 7-11.2A7 7 0 0 0 5 9.8C5 14.8 12 21 12 21Z"></path><circle cx="12" cy="9.5" r="2.4"></circle>
  </symbol>
  <symbol id="i-send" viewBox="0 0 24 24" fill="currentColor">
    <path d="M3 11.5 21 3l-6 18-4-7-8-2.5Z"></path>
  </symbol>
  ...
  <symbol id="i-home" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round">
    <path d="M4 11.5 12 4l8 7.5"></path><path d="M6 10v9h12v-9"></path>
  </symbol>
  <symbol id="i-home-fill" viewBox="0 0 24 24" fill="currentColor">
    <path d="M12 3 3 11h2v9h5v-6h4v6h5v-9h2L12 3Z"></path>
  </symbol>
  <symbol id="i-person" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round">
    <circle cx="12" cy="8" r="3.6"></circle><path d="M5 20c1-4 4-6 7-6s6 2 7 6"></path>
  </symbol>
  <symbol id="i-person-fill" viewBox="0 0 24 24" fill="currentColor">
    <circle cx="12" cy="8" r="4"></circle><path d="M4 21c1.2-4.6 4.6-7 8-7s6.8 2.4 8 7H4Z"></path>
  </symbol>
  <symbol id="i-heart" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round">
    <path d="M12 20s-7.5-4.8-9.8-9.4C.6 6.8 3 3.5 6.6 3.5c2 0 3.7 1.1 4.4 2.7.7-1.6 2.4-2.7 4.4-2.7 3.6 0 6 3.3 4.4 7.1C19.5 15.2 12 20 12 20Z"></path>
  </symbol>
  <symbol id="i-heart-fill" viewBox="0 0 24 24" fill="currentColor">
    <path d="M12 20s-7.5-4.8-9.8-9.4C.6 6.8 3 3.5 6.6 3.5c2 0 3.7 1.1 4.4 2.7.7-1.6 2.4-2.7 4.4-2.7 3.6 0 6 3.3 4.4 7.1C19.5 15.2 12 20 12 20Z"></path>
  </symbol>
  <symbol id="i-star" viewBox="0 0 24 24" fill="currentColor">
    <path d="M12 2.5l2.9 6.1 6.6.8-4.9 4.6 1.3 6.6L12 17.6l-5.9 3 1.3-6.6-4.9-4.6 6.6-.8L12 2.5Z"></path>
  </symbol>
