...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($errors)) {
        try {
            ...
            $_SESSION['flash'] = ['type' => 'success', 'message' => "공급처 '" . htmlspecialchars($name) . "'이(가) 성공적으로 추가되었습니다."];
        ...
        <div class="bg-white shadow-xl rounded-2xl">
            <div class="py-8 px-4 sm:px-10">
                <div class="text-center mb-8">
                    <h1 class="text-3xl font-bold tracking-tight text-gray-900">새 공급처 추가</h1>
                    <p class="mt-2 text-sm text-gray-600">새로운 공급처의 정보를 입력해주세요.</p>
                </div>
                ...
                <form action="add_supplier.php" method="post" class="space-y-6">
                    <div>
                        ...
                        <div class="mt-1">
                            <input type="text" id="name" name="name" class="block w-full rounded-md border-gray-300 shadow-sm focus:border-primary-500 focus:ring-primary-500 sm:text-sm py-2.5" value="<?php echo htmlspecialchars($name); ?>" required placeholder="거래처명">
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="mt-1">
                            <input type="text" id="phone" name="phone" class="block w-full rounded-md border-gray-300 shadow-sm focus:border-primary-500 focus:ring-primary-500 sm:text-sm py-2.5" value="<?php echo htmlspecialchars($phone); ?>" placeholder="전화번호">
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="mt-1">
                            <textarea id="memo" name="memo" rows="4" class="block w-full rounded-md border-gray-300 shadow-sm focus:border-primary-500 focus:ring-primary-500 sm:text-sm py-2.5" placeholder="중요사항 메모"><?php echo htmlspecialchars($memo); ?></textarea>
                        </div>
                    </div>

                    <div class="pt-5 border-t border-gray-200">
                        <div class="flex justify-end gap-x-3">
                            <a href="supplier_management.php" class="rounded-md bg-white py-2 px-4 text-sm font-medium text-gray-700 shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-gray-50">취소</a>
