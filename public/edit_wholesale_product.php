...
$page_title = '도매상품 수정' . ' - ' . t('company.name');
        ...
        try {
            ...
            if ($check_stmt->fetchColumn() > 0) {
                ...
                if ($update_success) {
                    $_SESSION['flash'] = [
                        'type' => 'success',
                        'message' => '도매상품이 성공적으로 수정되었습니다.'
                    ];
                    header('Location: wholesale_product_management.php');
                    exit;
                } else {
                    $errors[] = '도매상품 수정 중 오류가 발생했습니다.';
                }
            }
        } catch (PDOException $e) {
    ...
    <div class="max-w-3xl mx-auto">
                ...
                <ol class="flex items-center space-x-2">
                    ...
                    <li>
                        <div class="flex items-center">
                            ...
                            <span class="text-gray-600">상품 수정</span>
                        </div>
                    </li>
                </ol>
            </nav>
        ...
        <div class="bg-white shadow-sm rounded-lg border">
            <div class="px-6 py-4 border-b border-gray-200">
                ...
                <p class="mt-1 text-sm text-gray-600">도매상품 정보를 수정하세요.</p>
            </div>
                ...
                <form method="POST" class="space-y-6">
                    ...
                    <div>
                        ...
                        <div class="p-3 bg-gray-50 rounded-md border">
                            ...
                            <div class="text-xs text-gray-500 mt-1">
                                일반 판매가: <?php echo number_format($wholesale_product['selling_price']); ?>원
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-blue-50 p-4 rounded-lg border border-blue-200">
                        ...
                        <div class="mt-4">
                            ...
                            <textarea name="wholesale_description" id="wholesale_description" rows="3"
                                      class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-primary-500 focus:border-primary-500"
                                      placeholder="도매 고객에게 표시될 상품 설명을 입력하세요"><?php echo htmlspecialchars($_POST['wholesale_description'] ?? $wholesale_product['wholesale_description'] ?? ''); ?></textarea>
                        </div>
                    </div>
                    <?php endif; ?>
                    ...
                    <div>
                        <label for="wholesale_price" class="block text-sm font-medium text-gray-700">
                            도매가 <span class="text-red-500">*</span>
                        </label>
                    ...
                    <div>
                        ...
                        <input type="number" name="min_quantity" id="min_quantity" min="1" 
                               value="<?php echo htmlspecialchars($_POST['min_quantity'] ?? $wholesale_product['min_quantity']); ?>"
                               class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-primary-500 focus:border-primary-500"
                               placeholder="최소 주문수량">
